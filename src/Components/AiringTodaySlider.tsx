...
import { IGetTvResult, getAiringToday } from '../api';
...
function AiringTodaySlider() {
  ...
  const onBoxClick = (movieId: number) => {
    history.push(`/tv/${movieId}/airingToday`);
  };
  ...
  return (
    <>
      ...
      <AnimatePresence>
        {bigMovieMatch?.params.category === 'airingToday' ? (
          <>
            <Overlay
              ...
              animate={{ opacity: 1 }}
            />
            <BigMovie layoutId={bigMovieMatch.params.movieId + 'a'}>
              {clickedMovie && (
                <>
